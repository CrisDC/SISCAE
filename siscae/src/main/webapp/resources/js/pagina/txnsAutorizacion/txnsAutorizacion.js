$(document).ready(function() {
	...
	$local.tablaMantenimiento = $local.$tablaMantenimiento.DataTable({
		"ajax" : {
			"url" : $variableUtil.root + "txnsAutorizacion?accion=buscarTodos",
			"dataSrc" : ""
		},
		"language" : {
		...
		$.ajax({
			...
			success : function(detalleAutorizacion) {
				if(detalleAutorizacion.length == 0){
					$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacion.numeroCuenta+" ,fechaTransmisión: "+
					autorizacion.fechaTransmision+" ,númeroTrace: "+autorizacion.numeroRastreo+" ,tipoMensaje: "+autorizacion.tipoMensaje+" no encontró ninguna coincidencia en la Base de Datos.", "fa-exclamation-circle", "Información", "info");
				}else{
					if(detalleAutorizacion.length == 1){
						...
						$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacion.numeroCuenta+" ,fechaTransmisión: "+
						autorizacion.fechaTransmision+" ,númeroTrace: "+autorizacion.numeroRastreo+" ,tipoMensaje: "+autorizacion.tipoMensaje+" retornó más de un resultado", "fa-exclamation-circle", "Mensaje", "danger");
					}		
				}		
			}
		});
   		...
   		$.ajax({
   			...
   			success : function(detalleAutorizacion) {
   				if(detalleAutorizacion.length == 0){
   					...
   					$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacionSgte.numeroCuenta+" ,fechaTransmisión: "+
   					autorizacionSgte.fechaTransmision+" ,númeroTrace: "+autorizacionSgte.numeroRastreo+" ,tipoMensaje: "+autorizacionSgte.tipoMensaje+" no encontró ninguna coincidencia en la Base de Datos.", "fa-exclamation-circle", "Información", "info");
   				}else{
   					if(detalleAutorizacion.length == 1){
   	   					$local.$modalDetalleConsulta.PopupWindow("open");
   	   					$local.$modalDetalleConsulta.PopupWindow("maximize");
   	   					...
   	   					$local.$modalDetalleConsulta.PopupWindow("close");
   	   					$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacionSgte.numeroCuenta+" ,fechaTransmisión: "+
   	   					autorizacionSgte.fechaTransmision+" ,númeroTrace: "+autorizacionSgte.numeroRastreo+" ,tipoMensaje: "+autorizacionSgte.tipoMensaje+" retornó más de un resultado", "fa-exclamation-circle", "Mensaje", "danger");
   	   				}
   				}
   			}
   		});
      ...
      if ( currentPosition >= 0) {        	 
    	 ...
    	 $.ajax({
    			...
    			success : function(detalleAutorizacion) {
    				if(detalleAutorizacion.length == 0){
    					$local.$modalDetalleConsulta.PopupWindow("close");
       					$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacionAnt.numeroCuenta+" ,fechaTransmisión: "+
       					autorizacionAnt.fechaTransmision+" ,númeroTrace: "+autorizacionAnt.numeroRastreo+" ,tipoMensaje: "+autorizacionAnt.tipoMensaje+" no encontró ninguna coincidencia en la Base de Datos.", "fa-exclamation-circle", "Información", "info");
    				}else{
    					if(detalleAutorizacion.length == 1){
    	    				$local.$modalDetalleConsulta.PopupWindow("open");
    	     				$local.$modalDetalleConsulta.PopupWindow("maximize");
    	    				...
    	    				$local.$modalDetalleConsulta.PopupWindow("close");
    	   					$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacionAnt.numeroCuenta+" ,fechaTransmisión: "+
    	   					autorizacion.fechaTransmision+" ,númeroTrace: "+autorizacionAnt.numeroRastreo+" ,tipoMensaje: "+autorizacionAnt.tipoMensaje+" retornó más de un resultado", "fa-exclamation-circle", "Mensaje", "danger");
        				}
    				}
    			}
    		});	
	...
	$local.$btnPrimero.on("click",function(){
		...
		$.ajax({
			...
			success : function(detalleAutorizacion) {
				if(detalleAutorizacion.length == 0){
					$local.$modalDetalleConsulta.PopupWindow("close");
   					$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacionPrimero.numeroCuenta+" ,fechaTransmisión: "+
   					autorizacionPrimero.fechaTransmision+" ,númeroTrace: "+autorizacionPrimero.numeroRastreo+" ,tipoMensaje: "+autorizacionPrimero.tipoMensaje+" no encontró ninguna coincidencia en la Base de Datos.", "fa-exclamation-circle", "Información", "info");
				}else{
					if(detalleAutorizacion.length == 1 ){
						$local.$modalDetalleConsulta.PopupWindow("open");
						$local.$modalDetalleConsulta.PopupWindow("maximize");
						...
						$local.$modalDetalleConsulta.PopupWindow("close");
	   					$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacionPrimero.numeroCuenta+" ,fechaTransmisión: "+
	   					autorizacion.fechaTransmision+" ,númeroTrace: "+autorizacionPrimero.numeroRastreo+" ,tipoMensaje: "+autorizacionPrimero.tipoMensaje+" retornó más de un resultado", "fa-exclamation-circle", "Mensaje", "danger");
					}	
				}		
			}
		});
	...
	$local.$btnUltimo.on("click",function(){
		...
		$.ajax({
			...
			success : function(detalleAutorizacion) {
				if(detalleAutorizacion.length == 0){
					$local.$modalDetalleConsulta.PopupWindow("close");
   					$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacionUltimo.numeroCuenta+" ,fechaTransmisión: "+
   					autorizacionUltimo.fechaTransmision+" ,númeroTrace: "+autorizacionUltimo.numeroRastreo+" ,tipoMensaje: "+autorizacionUltimo.tipoMensaje+" no encontró ninguna coincidencia en la Base de Datos.", "fa-exclamation-circle", "Información", "info");
				}else{
					if(detalleAutorizacion.length == 1){
						$local.$modalDetalleConsulta.PopupWindow("open");
						$local.$modalDetalleConsulta.PopupWindow("maximize");
						...
						$local.$modalDetalleConsulta.PopupWindow("close");
	   					$funcionUtil.notificarException("La Búsqueda con los parámetros númeroTarjeta: "+autorizacionUltimo.numeroCuenta+" ,fechaTransmisión: "+
	   					autorizacion.fechaTransmision+" ,númeroTrace: "+autorizacionUltimo.numeroRastreo+" ,tipoMensaje: "+autorizacionUltimo.tipoMensaje+" retornó más de un resultado", "fa-exclamation-circle", "Mensaje", "danger");
					}
				}
			}
		});
