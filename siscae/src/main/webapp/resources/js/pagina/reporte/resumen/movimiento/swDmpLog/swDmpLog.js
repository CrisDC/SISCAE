$(document).ready(function() {
	...
	$local.$buscar.on("click", function() {
		...
		$.ajax({
			type : "GET",
			url : $variableUtil.root + "reporte/resumen/movimiento/swDmpLog?accion=buscar",
	...
	$local.$exportarXlsx.on("click", function() {
		...
		window.location.href = $variableUtil.root + "reporte/resumen/movimiento/swDmpLog?accion=exportar&" + paramCriterioBusqueda;
	});
});