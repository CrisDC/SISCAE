$(document).ready(function() {
	...
	$local.$tablaMantenimiento.children("tbody").on("click", ".actualizar", function() {
		...
		var multiTabDet = $local.tablaMantenimiento.row($local.$filaSeleccionada).data();
		$local.id_tablaSeleccionado = multiTabDet.idTabla;
	...
	$local.$tablaMantenimiento.children("tbody").on("click", ".aniadir-detalle", function() {
		...
		$local.$filaSeleccionada = $(this).parents("tr");
		var multiTabDet = $local.tablaMantenimiento.row($local.$filaSeleccionada).data();
		$(document).trigger("abrirDetalleMantenimiento", [ multiTabDet.idTabla, $local.tablaMantenimiento ]);
	});
	...
	$local.$actualizarMantenimiento.on("click", function() {
		...
		var multiTabDet = $formMantenimiento.serializeJSON();
		multiTabDet.idTabla = $local.id_tablaSeleccionado;
		$.ajax({
			type : "PUT",
			url : $variableUtil.root + "multiTabDet",
			data : JSON.stringify(multiTabDet),
	...
	$local.$tablaMantenimiento.children("tbody").on("click", ".eliminar", function() {
		...
		$.confirm({
			...
			title : "Aviso",
			content : "¿Desea eliminar la tabla <b>'" + multiTabDet.idTabla + " - " + multiTabDet.descripcion + "'<b/>?",
			buttons : {
				Aceptar : {
					action : function() {
