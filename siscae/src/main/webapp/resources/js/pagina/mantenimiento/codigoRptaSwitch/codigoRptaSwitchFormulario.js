	...
	$formMantenimiento.validate({
		...
		messages : {
			codigoRespuestaSwitch : {
				...
				number : "El C&oacute;digo de Respuesta Switch debe contener solo n&uacute;meros.",
				range : "El C&oacute;digo de Respuesta Switch debe estar entre 0 y 999."
			},
			descripcion : {
			...
			tipoRespuesta : {
				...
				selectlength : "El Tipo de Respuesta debe contener entre 1 y 4 car&aacute;cteres."
			}
		}
	});
