$(document).ready(function() {
	...
	$local.$tablaMantenimiento.children("tbody").on("click", ".eliminar", function() {
		...
		$.confirm({
			...
			title : "Aviso",
			content : "¿Desea eliminar el Rol <b>'" + rol.idRol + " - " + rol.nombre + "'<b/>?",
			buttons : {
				Aceptar : {
					action : function() {
							...
							content : function() {
								...
								$.ajax({
									...
									case 400:
										...
										break;
									case 409:
										var mensaje = $funcionUtil.obtenerMensajeError("El Rol <b>" + Rol.idRol + " - " + rol.nombre + "</b>", xhr.responseJSON, $variableUtil.accionEliminado);
