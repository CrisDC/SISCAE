...
$(document).ready(function() {
	...
	$variableUtil = {
		...
		botonEliminarSolicitante : "<button class='btn btn-danger eliminar-soli' title='Eliminar'><i class='fa fa-trash-o'></i></button>",
		botonActualizarSolicitante : "<button class='btn btn-success actualizar-soli' title='Actualizar'><i class='fa fa-cog'></i></button>",
