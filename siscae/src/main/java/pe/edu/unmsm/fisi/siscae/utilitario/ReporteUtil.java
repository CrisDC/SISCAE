...
public class ReporteUtil
{
            ...
            int tipoPresentacion)
    {
      ...
      /*  String verboTipoPresentacion = (tipoPresentacion == PRESENTACION_POR_DIA)
                ? VerboConstantes.AUTORIZACION_POR_DIA : VerboConstantes.AUTORIZACION_POR_MES;*/
        return null;// sb.append(tipoAutorizacion.toUpperCase()).append("_").append(verboTipoPresentacion).toString();
    }
