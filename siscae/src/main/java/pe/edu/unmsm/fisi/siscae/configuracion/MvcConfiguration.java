...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "pe.edu.unmsm.fisi.siscae.controller", "pe.edu.unmsm.fisi.siscae.aspecto",
        "pe.edu.unmsm.fisi.siscae.configuracion.security" })
...
public class MvcConfiguration extends WebMvcConfigurerAdapter implements ApplicationContextAware
{
    ...
    public MessageSource messageSource()
    {
        ...
        bean.setBasenames("classpath:/message/validacion", 
                "classpath:/message/mantenimiento",
                "classpath:/message/reporte", 
                "classpath:/message/exception",
                "classpath:/message/consulta", 
                "classpath:/message/seguridad", 
                "classpath:/message/webservice",
                "classpath:/message/configuration");
