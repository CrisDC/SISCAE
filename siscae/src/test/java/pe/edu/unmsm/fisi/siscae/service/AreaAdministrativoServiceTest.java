...
public class AreaAdministrativoServiceTest {
	...
	public void registrarAreaAdministrativoTest() {
		...
		assertTrue(areaAdministrativoService.existe(areaAdministrativoTest.getIdAreaAdministrativo()));
	}
	...
	public void buscarPorIdAreaAdministrativoTest() {// puede ser tamaño uno
		AreaAdministrativo areaAdministrativo = areaAdministrativoService.buscarPorId(1);
		System.out.println(areaAdministrativo);
	}

	@Test
	public void existeAreaAdministrativoTest() {

		assertTrue(areaAdministrativoService.existe(1));// el id ingresado de
														// arriba
	}
	...
	public void eliminarAreaAdministrativo() {
		...
		assertFalse(areaAdministrativoService.existe(areaAdministrativoTest.getIdAreaAdministrativo()));
